=== WooCommerce EPOS Gateway ===
Contributors: nmekh
Tags: commerce, woocommerce, epos, shopping, gateway, erip
Stable tag: 1.0.0
...
Woocommerce EPOS (Belarus) integration
...
== Installation ==
1. Upload the plugin files to the `/wp-content/plugins/woo-epos-gateway` directory, or install the plugin through the WordPress plugins screen directly.
