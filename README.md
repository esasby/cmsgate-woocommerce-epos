...
Данный модуль обеспечивает взаимодействие между интернет-магазином на базе CMS WordPress с модулем электронной коммерции WooCommerce и сервисом платежей [EPOS](https://e-pos.by)
...
1. Выберите загруженный в п2. архив модуля wc-epos-gateway.zip и установите
...
_Разработано и протестировано с Wordpress v6.0 и WooCommerce v6.6.0_
